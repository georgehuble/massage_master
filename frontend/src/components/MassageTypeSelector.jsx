...
//     const firstDuration = type.durations[0];
//     setLocalSelectedDuration(firstDuration);
    
//     if (onTypeSelect) onTypeSelect(type);
//     if (onDurationSelect) onDurationSelect(firstDuration);
//   };
...
//       {currentSelectedType && currentSelectedDuration && (
//         <motion.div
...
//                 <span className="font-semibold">Выбран:</span> {currentSelectedType.name}
//               </p>
//               <p className="text-sm text-gray-600 mt-1">
//                 Длительность: <span className="font-medium">{currentSelectedDuration.time} минут</span>
//                 {currentSelectedDuration.time > 60 && (
//                   <span className="text-xs ml-2 text-orange-600">
//                     + перерыв включен автоматически
//                   </span>
//                 )}
//               </p>
//             </div>
//             <div className="text-right">
//               <p className="text-2xl font-bold text-blue-600">{currentSelectedDuration.price} ₽</p>
//             </div>
//           </div>
//         </motion.div>
//       )}
                      ...
                      <AnimatePresence mode="wait">
                        {currentSelectedDuration && (
                          ...
                          >
                            <div className="flex-1">
                              <p className="text-sm text-gray-700">
                                <span className="font-semibold">Выбрано:</span> {currentSelectedDuration.time} минут
                                {currentSelectedDuration.time > 60 && (
                                  <span className="text-xs ml-2 text-orange-600">
                                    + перерыв включен
                                  </span>
                              ...
                              <p className="text-lg font-bold text-blue-600">{currentSelectedDuration.price} ₽</p>
                            </div>
                            <motion.button
                              onClick={onNext}
